...
import { FaPlay, FaTimes, FaRedo, FaCheck } from 'react-icons/fa';
import { getUserPlaylists, getPlaylistTracks } from '../../../services/spotifyApi';
import type { SpotifyPlaylist, SpotifyTrack } from '../../../services/spotifyApi';
...
function BlindTestPage() {
  ...
  const renderSetup = () => (
    <Box>
      ...
      <Text color="spotify.lightGray" mb={8}>
        Testez vos connaissances musicales en devinant les morceaux
      </Text>

      <Text fontSize="lg" fontWeight="semibold" color="spotify.white" mb={4}>
        Mes playlists
      </Text>
      ...
      {loading ? (
        ...
        <>
          ...
          <Button
            ...
            fontWeight="bold"
            _hover={{ bg: '#1ed760' }}
            _disabled={{ opacity: 0.5, cursor: 'not-allowed', bg: 'gray.600' }}
          >
  ...
  const renderResults = () => (
    <Box>
      ...
      >
        ...
        <Text fontSize="xl" fontWeight="bold" color="spotify.dark">
          {selectedPlaylist?.name}
        </Text>
      </Flex>
      ...
      <VStack gap={3} align="stretch" mb={8}>
        {playedTracks.map(({ track, wasCorrect }, index) => (
          ...
          >
            ...
            />
            <Box flex={1}>
              <Text color="spotify.white" fontWeight="medium">
                {track.name}
              </Text>
